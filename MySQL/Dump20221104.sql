...
INSERT INTO `administrador` VALUES (1,'LOGISTICA'),(2,'FINANZAS'),(4,'Info'),(7,'');
...
INSERT INTO `cliente` VALUES (1,'F',1),(2,'F',0),(3,'F',1),(4,'hols',0),(5,'',1),(6,'j',1);
...
--
-- Dumping data for table `documentoCredito`
--

LOCK TABLES `documentoCredito` WRITE;
/*!40000 ALTER TABLE `documentoCredito` DISABLE KEYS */;
/*!40000 ALTER TABLE `documentoCredito` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `documentoDebito`
--

LOCK TABLES `documentoDebito` WRITE;
/*!40000 ALTER TABLE `documentoDebito` DISABLE KEYS */;
/*!40000 ALTER TABLE `documentoDebito` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `empresa` VALUES (1,'202353425','Happy SAC','san miguel'),(5,'uiuiuiuiui','hola mundo','calee hola');
...
INSERT INTO `persona` VALUES (1,'Pasaporte','E43534566','Pedro','Aquino','1998-03-10','987771135','Av. Castillo 182','jkl123@gmail.com',1),(2,'DNI','74623938','Juana','Galvez','1988-10-10','987234561','Av. Arequipa 112','juana123@gmail.com',0),(3,'DNI','2343412351','sdffgsdg','ewrweqr','2022-10-29','3412345123','sdfasdf','sdfasdf',0),(4,'CE','001309775','Yiming','Xuan','2010-10-19','946330816','san isidro','yxuan@pucp.edu.pe',1),(5,'DNI','45454545','pat','es','2022-10-31','62319ggg','khih','pad62',1),(6,'DNI','76431839','pat','espa','2022-10-31','96854565','asdnk','pat@pucp.pe',1),(7,'DNI','45457878','Pat','Eso','2022-10-31','78945611ds','askdba','osdnaods',1);
...
INSERT INTO `personaNatural` VALUES (2,'Pasaporte','34253253','xuan','gafsdfs','2022-10-29','4563465','','afsdfsaerdf'),(3,'DNI','34252345','Omar 1','Ruiz','2001-10-29','4352345444','','OmarR@pucp.edu.pe'),(4,'DNI','76431839','Patricia','Esparza','1998-03-18','962802989','calle hola 123','patricia.esparza@pucp.pe'),(6,'DNI','sadasa','Kitty','s','2022-10-31','s','f','d');
...
--
-- Dumping data for table `terminoDePago`
--

LOCK TABLES `terminoDePago` WRITE;
/*!40000 ALTER TABLE `terminoDePago` DISABLE KEYS */;
/*!40000 ALTER TABLE `terminoDePago` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `usuario` VALUES (1,'jaq1998','contrasena17','2022-03-10'),(2,'jgalvez1','269dd00ab2b23156677b0b1cb8840853','2022-09-15'),(3,'2314234ewrwqe','8e3b8ba1ad0a090d894f76bf9b70c52a','2022-10-29'),(4,'xuan','e10adc3949ba59abbe56e057f20f883e','2022-10-29'),(5,'cold123','fcea920f7412b5da7be0cf42b8c93759','2022-10-31'),(6,'paesparza','8081495505fc811ec36065c41c5c62ed','2022-10-31'),(7,'pa123','8081495505fc811ec36065c41c5c62ed','2022-10-31');
...
INSERT INTO `vendedor` VALUES (3,0),(5,0),(6,0);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `BUSCAR_SUPERVISOR_X_ALMACEN` */;
...
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `BUSCAR_SUPERVISOR_X_ALMACEN`(
	IN _id_almacen INT
)
BEGIN
	select s.id_usuario,p.nombre,p.apellido from supervisorDeAlmacen s
    inner join persona p
    on id_usuario=id_persona
    inner join almacen a
    on fid_almacen=id_almacen
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `BUSCAR_USUARIO`(
	IN _id_usuario INT 
)
BEGIN
	SELECT u.*,cantidad_ventas,fid_almacen,area 
    FROM usuario u
...
BEGIN
    ...
    INSERT INTO usuario(id_usuario, username,password,fecha_de_ingreso) VALUES(_id_usuario, _username,MD5(_password),_fecha_de_ingreso);
...
BEGIN
    INSERT INTO producto(id_producto,fid_almacen,codigo_lote,nombre,precio,costo,cantidad,devuelto,fecha_ingreso,activo) 
			VALUES(_id_producto,_fid_almacen,_codigo_lote,_nombre,_precio,_costo,_cantidad,_devuelto,_fecha_ingreso,1);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LISTAR_ADMINISTRADORES_X_DOCUMENTO_NOMBRE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `LISTAR_ADMINISTRADORES_X_DOCUMENTO_NOMBRE`(
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LISTAR_CLIENTE_X_NOMBRE_DNI,RAZON_RUC` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `LISTAR_CLIENTE_X_NOMBRE_DNI,RAZON_RUC`(
...
BEGIN
    ...
    p.nombre, p.apellido, p.fecha_de_nacimiento, p.telefono, p.direccion, p.email, p.tipo_de_documento, p.numero_de_documento
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LISTAR_EMPRESAS_X_RUC_NOMBRE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `LISTAR_EMPRESAS_X_RUC_NOMBRE`(
	IN _RUC_nombre VARCHAR(80)
)
BEGIN
    SELECT  c.id_cliente, e.RUC, e.razon_social, e.direccion ,c.categoria 
    FROM cliente c INNER JOIN empresa e ON c.id_cliente = e.id_empresa 
    WHERE c.activo = 1
    AND (e.razon_social LIKE CONCAT('%',_RUC_nombre,'%'))
	OR (e.RUC LIKE CONCAT('%',_RUC_nombre,'%'));
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LISTAR_ORDENES_DE_COMPRA_ULTIMAS_50` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `LISTAR_ORDENES_DE_COMPRA_ULTIMAS_50`()
BEGIN
	WITH ultimas50 as
    (SELECT id_orden_de_compra,fid_cliente,fid_vendedor,fid_moneda ,monto,direccion_de_entrega,forma_de_entrega,fecha_de_compra,fecha_de_entrega,pagado, row_number() over(order by fecha_de_compra desc) as rn
	FROM ordenDeCompra WHERE activo = 1 )
    SELECT id_orden_de_compra,fid_cliente,fid_vendedor,fid_moneda ,monto,direccion_de_entrega,forma_de_entrega,fecha_de_compra,fecha_de_entrega,pagado
    FROM ultimas50 WHERE rn<=50;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SELECT id_orden_de_compra,fid_cliente,fid_vendedor,fid_moneda ,monto,direccion_de_entrega,forma_de_entrega,fecha_de_compra,fecha_de_entrega,pagado
    FROM ordenDeCompra WHERE activo = 1 AND _id_cliente = fid_cliente;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SELECT id_orden_de_compra,fid_cliente,fid_vendedor,fid_moneda ,monto,direccion_de_entrega,forma_de_entrega,fecha_de_compra,fecha_de_entrega,pagado
    FROM ordenDeCompra WHERE activo = 1 AND _fecha = fecha_de_compra;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LISTAR_PEDIDOS_X_ORDEN_DE_COMPRA` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `LISTAR_PEDIDOS_X_ORDEN_DE_COMPRA`(
	IN _id_orden_de_compra INT
)
BEGIN
	SELECT id_pedido,fid_producto,fid_orden_de_compra, descuento 
    FROM pedido WHERE fid_orden_de_compra = _id_orden_de_compra AND activo = 1;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LISTAR_PERSONAS_NATURALES_X_DOCUMENTO_NOMBRE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `LISTAR_PERSONAS_NATURALES_X_DOCUMENTO_NOMBRE`(
	IN _doc_nombre VARCHAR(80)
)
BEGIN
...
BEGIN
	SELECT id_producto,fid_almacen,nombre,codigo_lote,precio,costo,cantidad,devuelto,fecha_ingreso
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LISTAR_SUPERVISORES_DE_ALMACEN_X_DOCUMENTO_NOMBRE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `LISTAR_SUPERVISORES_DE_ALMACEN_X_DOCUMENTO_NOMBRE`(
	IN _doc_nombre VARCHAR(80)
)
BEGIN
	SELECT s.id_usuario, p.nombre, p.apellido, p.telefono, p.direccion, p.email, p.fecha_de_nacimiento, p.tipo_de_documento, p.numero_de_documento,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LISTAR_TODOS_CLIENTES` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `LISTAR_TODOS_CLIENTES`()
BEGIN
	SELECT  c.id_cliente, c.categoria,
    e.RUC, e.razon_social, e.direccion ,
    p.nombre, p.apellido, p.fecha_de_nacimiento, p.telefono, p.direccion, p.email, p.tipo_de_documento, p.numero_de_documento
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `LISTAR_USUARIO`(
	IN _id_usuario INT 
)
BEGIN
	SELECT u.*,p.*,cantidad_ventas,fid_almacen,area 
    FROM usuario u
...
BEGIN
	SELECT p.id_persona,u.id_usuario, p.nombre, p.apellido, p.telefono, p.direccion, p.email, p.fecha_de_nacimiento, p.tipo_de_documento, p.numero_de_documento,
			u.username,u.password, u.fecha_de_ingreso, v.cantidad_ventas, a.area,s.fid_almacen
    FROM persona p 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LISTAR_VENDEDORES_X_DOCUMENTO_NOMBRE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminjoya`@`%` PROCEDURE `LISTAR_VENDEDORES_X_DOCUMENTO_NOMBRE`(
	IN _doc_nombre VARCHAR(80)
)
BEGIN
	SELECT p.id_persona, p.nombre, p.apellido, p.telefono, p.direccion, p.email, p.fecha_de_nacimiento, p.tipo_de_documento, p.numero_de_documento,
...
BEGIN
	UPDATE producto SET fid_almacen = _fid_almacen, codigo_lote=_codigo_lote,nombre = _nombre, precio = _precio, costo = _costo, cantidad = _cantidad, 
						devuelto =_devuelto, fecha_ingreso = _fecha_ingreso, activo = _activo
...
BEGIN
	SELECT u.*,p.*,cantidad_ventas,fid_almacen,area FROM usuario u
    inner join persona p on u.id_usuario=p.id_persona
    left join vendedor v on u.id_usuario=v.id_usuario
    left join supervisorDeAlmacen s on u.id_usuario=s.id_usuario
    left join administrador a on u.id_usuario=a.id_usuario
...
-- Dump completed on 2022-11-04 18:13:52
