...
DROP PROCEDURE IF EXISTS LISTAR_EMPRESAS_X_RUC_NOMBRE;
...
DROP PROCEDURE IF EXISTS LISTAR_PERSONAS_NATURALES_X_DOCUMENTO_NOMBRE;
...
DROP PROCEDURE IF EXISTS LISTAR_SUPERVISORES_DE_ALMACEN_X_DOCUMENTO_NOMBRE;
...
DROP PROCEDURE IF EXISTS LISTAR_VENDEDORES_X_DOCUMENTO_NOMBRE;
...
DROP PROCEDURE IF EXISTS LISTAR_ADMINISTRADORES_X_DOCUMENTO_NOMBRE;
...
DROP PROCEDURE IF EXISTS LISTAR_TODOS_DOCUMENTOS_DEBITO;
...
DELIMITER $
CREATE PROCEDURE LISTAR_EMPRESAS_X_RUC_NOMBRE(
...
DELIMITER $
CREATE PROCEDURE LISTAR_PERSONAS_NATURALES_X_DOCUMENTO_NOMBRE(
...
DELIMITER $
CREATE PROCEDURE LISTAR_SUPERVISORES_DE_ALMACEN_X_DOCUMENTO_NOMBRE(
...
DELIMITER $
CREATE PROCEDURE LISTAR_VENDEDORES_X_DOCUMENTO_NOMBRE(
	_doc_nombre VARCHAR(80)
)
BEGIN
	SELECT p.id_persona, p.nombre, p.apellido, p.telefono, p.direccion, p.email, p.fecha_de_nacimiento, p.tipo_de_documento, p.numero_de_documento,
...
DELIMITER $
CREATE PROCEDURE LISTAR_ADMINISTRADORES_X_DOCUMENTO_NOMBRE(
	_doc_nombre VARCHAR(80)
)
BEGIN
	SELECT p.id_persona, p.nombre, p.apellido, p.telefono, p.direccion, p.email, p.fecha_de_nacimiento, p.tipo_de_documento, p.numero_de_documento,
